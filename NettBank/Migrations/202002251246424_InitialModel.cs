namespace NettBank.Migrations
{
    ...
    public partial class InitialModel : DbMigration
    {
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Name = c.String(),
                        LoanCompany_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.LoanCompanies", t => t.LoanCompany_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.LoanTypes", "LoanCompany_Id", "dbo.LoanCompanies");
            ...
            DropIndex("dbo.LoanTypes", new[] { "LoanCompany_Id" });
