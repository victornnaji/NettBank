namespace NettBank.Migrations
{
    ...
    public partial class AddDatabase5 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.LoanTypeId, t.LoanCompanyId })
                .ForeignKey("dbo.LoanCompanies", t => t.LoanTypeId, cascadeDelete: true)
                .ForeignKey("dbo.LoanTypes", t => t.LoanCompanyId, cascadeDelete: true)
                .Index(t => t.LoanTypeId)
                .Index(t => t.LoanCompanyId);
